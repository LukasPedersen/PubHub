...
using PubHubWeb.Client.Pages;
using PubHubWeb.Components;
using PubHubWeb.Components.Account;
using PubHubWeb.Data;
using PubHubWeb.Data.Models;
using System.Security.Claims;
using PubHubWeb.Services;
...
namespace PubHubWeb
{
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            config.Title = "PubHub API");
            builder.Services.AddSwaggerGen(c =>
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "PubHub API", Version = "v1" });
            });
